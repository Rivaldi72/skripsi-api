...
class Helper
{
    public static function applClasses($name)
    {
        // Demo
    ...
    public static function applClassesChairiah() {
        return self::applClasses('chairiah');
    }

    public static function applClassesDedi() {
        return self::applClasses('dedi');
    }
    
    public static function applClassesGedmi() {
        return self::applClasses('gedmi');
    }

    public static function applClassesGeral() {
        return self::applClasses('geral');
    }
