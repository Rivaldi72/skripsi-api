<body
    ...
    <!-- BEGIN: Header-->
    @include('panels.gedmi.navbar')
    <!-- END: Header-->

    <!-- BEGIN: Main Menu-->
    @if (isset($configData['showMenu']) && $configData['showMenu'] === true)
        @include('panels.gedmi.sidebar')
    @endif
    <!-- END: Main Menu-->
    ...
    <div class="app-content content {{ $configData['pageClass'] }}">
        ...
        @if ($configData['contentLayout'] !== 'default' && isset($configData['contentLayout']))
            <div class="content-area-wrapper {{ $configData['layoutWidth'] === 'boxed' ? 'container-xxl p-0' : '' }}">
                <div class="{{ $configData['sidebarPositionClass'] }} kjhaskhashkahs">
                    <div class="sidebar">
        ...
        @else
            <div class="content-wrapper {{ $configData['layoutWidth'] === 'boxed' ? 'container-xxl p-0' : '' }}">
                ...
                @if ($configData['pageHeader'] === true && isset($configData['pageHeader']))
                    @include('panels.gedmi.breadcrumb')
                @endif
    ...
    {{-- include footer --}}
    @include('panels/gedmi/footer')

    {{-- include default scripts --}}
    @include('panels/gedmi/scripts')
