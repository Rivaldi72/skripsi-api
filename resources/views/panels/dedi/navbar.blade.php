...
<div class="navbar-container d-flex content">
    <div class="bookmark-wrapper d-flex align-items-center">
        ...
        <ul class="nav navbar-nav bookmark-icons">
            <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ url('/dedi/daftarsiswa') }}"
                    data-bs-toggle="tooltip" data-bs-placement="bottom" title="Daftar Siswa"><i class="ficon"
                        data-feather="user"></i></a></li>
            <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ url('/dedi/materiindex') }}"
                    data-bs-toggle="tooltip" data-bs-placement="bottom" title="Materi"><i class="ficon"
                        data-feather="book-open"></i></a></li>
            <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ url('/dedi/pratikumindex') }}"
                    data-bs-toggle="tooltip" data-bs-placement="bottom" title="Pratikum"><i class="ficon"
                        data-feather="thermometer"></i></a></li>
            <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ url('/dedi/latihanindex') }}"
                    data-bs-toggle="tooltip" data-bs-placement="bottom" title="Latihan"><i class="ficon"
