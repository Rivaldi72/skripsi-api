        ...
        <li class="nav-item dropdown dropdown-user">
                ...
                <div class="user-nav d-sm-flex d-none">
                    <span class="user-name fw-bolder">
                        @if (Auth::check())
                            {{ Auth::user()->name }}
                        @else
                            {{ dd(session('nama') == '' ? 'Test' : 'Gudang Kopi') }}
                            {{ session('nama') == '' ? session('nama') : 'Gudang Kopi' }}
                        @endif
                    </span>
                    <span class="user-status">
                        {{ session('nama') == '' ? session('alamat') : 'Alamat Gudang' }}
                    </span>
                </div>
                <span class="avatar">
                    <img class="round"
                        src="{{ Auth::user() ? Auth::user()->profile_photo_url : asset('images/chairiah/2.png') }}"
            ...
            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                @if (session('username') != null)
                    <a class="dropdown-item" href="{{ route('chairiah.logout') }}">
