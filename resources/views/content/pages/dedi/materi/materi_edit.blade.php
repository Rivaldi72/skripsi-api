                        ...
                        <form action="{{ route('dedi.materi.update', ['id' => $materi->id]) }}" method="PUT"
                                ...
                                <div class="mb-1">
                                    ...
                                    <div class="mb-1">
                                        <select class="form-select form-select-lg" id="mata_pelajaran"
                                            ...
                                            <option value="1" {{ $materi->id_mapel == 1 ? 'selected' : '' }}>
                                                Bakteriologi</option>
                                            <option value="2" {{ $materi->id_mapel == 2 ? 'selected' : '' }}>Hematologi
                                            </option>
                                            <option value="3" {{ $materi->id_mapel == 3 ? 'selected' : '' }}>Patologi
                                                Klinik</option>
                                            <option value="4" {{ $materi->id_mapel == 4 ? 'selected' : '' }}>
                                                Parasitologi</option>
                                            <option value="5" {{ $materi->id_mapel == 5 ? 'selected' : '' }}>Imunologi
                                            </option>
                                            <option value="6" {{ $materi->id_mapel == 6 ? 'selected' : '' }}>Serologi
                                            </option>
                                            <option value="7" {{ $materi->id_mapel == 7 ? 'selected' : '' }}>Kimia
                                                Makanan</option>
                                            <option value="8" {{ $materi->id_mapel == 8 ? 'selected' : '' }}>Kimia
                                                Minuman</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" class="form-control form-control-lg" id="judul_materi"
                                        placeholder="Masukkan Judul Materi" name='judul_materi'
