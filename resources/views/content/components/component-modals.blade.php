                            ...
                            <div class="modal-size-sm d-inline-block">
                                ...
                                <div class="modal fade text-start" id="small" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-sm">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                < h4 class="modal-title" id="myModalLabel19">Small Modal</>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                    ...
                    <div class="card-body">
                        <div class="demo-inline-spacing">
                            ...
                            <div class="show-event-ex">
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal"
                                    id="onshowbtn" data-bs-target="#onshow">
                                    On Show Event
                                </button>
                                <!-- Modal -->
                            ...
                            <div class="shown-event-ex">
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal"
                                    id="onshownbtn" data-bs-target="#onshown">
                                    On Shown Event
                                </button>
                                <!-- Modal -->
                            ...
                            <div class="hide-event-ex">
                                <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal"
                                    id="onhidebtn" data-bs-target="#onhide">
                                    On Hide Event
                                </button>
                                <!-- Modal -->
